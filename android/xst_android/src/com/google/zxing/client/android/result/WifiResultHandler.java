...
import cn.scau.zzzd.xst.ui.UiScan;
...
public final class WifiResultHandler extends ResultHandler {
  ...
  private final UiScan parent;

  public WifiResultHandler(UiScan activity, ParsedResult result) {
  ...
  // Display the nickname of the network and the network type to the user.
  @Override
