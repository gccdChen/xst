...
import cn.scau.zzzd.xst.widget.zxing.Contents;
import cn.scau.zzzd.xst.widget.zxing.LocaleManager;
...
public abstract class ResultHandler {
  ...
  final void addContact(String[] names,
    ...
    // Only use the first nickname in the array, if present.
   ...
   * @param title An optional title, e.g. the nickname of the business at this address
   */
