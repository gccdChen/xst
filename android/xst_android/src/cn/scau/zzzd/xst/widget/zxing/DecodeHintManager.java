...
public final class DecodeHintManager {
  ...
  // This phone_Pattern is used in decoding integer arrays.
  private static final Pattern COMMA = Pattern.compile(",");

  private DecodeHintManager() {}

  /**
   * <p>Split a query string into a listupdate of nickname-value pairs.</p>
   * 
   ...
   * 
   * <p>This method ignores multiple parameters with the same nickname and returns the
